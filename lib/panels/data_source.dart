...
class dataSource{
  ...
  static String quoteAr ="لا يخشى شيء في الحياة ، بل يجب فهمه فقط. حان الوقت الآن لفهم المزيد ، حتى نخشى أقل.";
  ...
  static List questionAnswersAr = [
    {
      ...
      "answer": "فيروسات كورونا هي فصيلة كبيرة من الفيروسات التي قد تسبب المرض للحيوان أو للإنسان. في البشر ، من المعروف أن العديد من فيروسات كورونا تسبب التهابات في الجهاز التنفسي تتراوح من نزلات البرد إلى أمراض أكثر شدة مثل متلازمة الشرق الأوسط التنفسية (ميرس) ومتلازمة الجهاز التنفسي الحاد (سارس). أحدث فيروس كورونا تم اكتشافه يسبب مرض فيروس كورونا COVID-19."
    },
    {
    ...
    },
    {
      ...
      "answer":
      "الأعراض الأكثر شيوعًا لـ COVID-19 هي الحمى والتعب والسعال الجاف. قد يعاني بعض المرضى من الأوجاع والآلام واحتقان الأنف وسيلان الأنف والتهاب الحلق أو الإسهال. عادة ما تكون هذه الأعراض خفيفة وتبدأ تدريجيًا. يصاب بعض الأشخاص بالعدوى ولكن لا تظهر عليهم أي أعراض ولا يشعرون بتوعك. يتعافى معظم الناس (حوالي 80٪) من المرض دون الحاجة إلى علاج خاص. يصاب حوالي 1 من كل 6 أشخاص مصابين بـ COVID-19 بمرض خطير ويصاب بصعوبة في التنفس. كبار السن وأولئك الذين يعانون من مشاكل طبية أساسية مثل ارتفاع ضغط الدم أو مشاكل القلب أو مرض السكري هم أكثر عرضة للإصابة بأمراض خطيرة. يجب على الأشخاص المصابين بالحمى والسعال وصعوبة التنفس التماس العناية الطبية."
    },
    {
      "question": "كيف ينتشر مرض كوفيد -19؟",
      "answer":
      "يمكن للأشخاص التقاط COVID-19 من الآخرين المصابين بالفيروس. يمكن أن ينتشر المرض من شخص لآخر من خلال قطرات صغيرة من الأنف أو الفم والتي تنتشر عندما يسعل أو يزفر الشخص المصاب بـ COVID-19. تسقط هذه القطرات على الأشياء والأسطح حول الشخص. يصاب أشخاص آخرون بعد ذلك بـ COVID-19 عن طريق لمس هذه الأشياء أو الأسطح ، ثم لمس عيونهم أو أنفهم أو فمهم. يمكن للأشخاص أيضًا التقاط COVID-19 إذا استنشقوا قطرات من شخص مصاب بـ COVID-19 يسعل أو يزفر قطرات. هذا هو السبب في أنه من المهم الابتعاد أكثر من متر واحد (3 أقدام) عن الشخص المريض. \ n تقوم منظمة الصحة العالمية بتقييم البحث الجاري حول طرق انتشار COVID-19 وستواصل مشاركة النتائج المحدثة."
    },
    {
      "question": "هل يمكن للفيروس المسبب لـ COVID-19 أن ينتقل عن طريق الهواء؟",
      "answer": "تشير الدراسات حتى الآن إلى أن الفيروس الذي يسبب COVID-19 ينتقل بشكل أساسي من خلال ملامسة الرذاذ التنفسي وليس عن طريق الهواء"
    },
    {
      "question": "هل يمكن التقاط كوفيد -19 من شخص لا تظهر عليه أعراض؟",
      "answer":
      "الطريقة الرئيسية لانتشار المرض هي من خلال الرذاذ التنفسي الذي يطرده شخص يسعل. خطر الإصابة بـ COVID-19 من شخص ليس لديه أعراض على الإطلاق منخفض للغاية. ومع ذلك ، فإن العديد من الأشخاص المصابين بـ COVID-19 يعانون من أعراض خفيفة فقط. هذا صحيح بشكل خاص في المراحل المبكرة من المرض. لذلك من الممكن الإصابة بـ COVID-19 من شخص يعاني ، على سبيل المثال ، من سعال خفيف ولا يشعر بالمرض. تقوم منظمة الصحة العالمية بتقييم الأبحاث الجارية حول فترة انتقال COVID-19 وستواصل مشاركة النتائج المحدثة."
    },
    {
      "question":
